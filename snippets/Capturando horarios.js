...
for(j in indices_dia_semana){
    ...
    for(k in barra_split_horarios_strings){
        ...
        if(indice_intervalos_de_tempo_dia == 0){
            intervalos_de_tempo_dia.push([inicio_horario,fim_horario])
        }
        
        if(indice_intervalos_de_tempo_dia > 0 && inicio_horario === intervalos_de_tempo_dia[indice_intervalos_de_tempo_dia - 1][1]){
            intervalos_de_tempo_dia[indice_intervalos_de_tempo_dia - 1][1] = fim_horario;
        }else{
            intervalos_de_tempo_dia.push([inicio_horario, fim_horario]);
        }

        
        indice_intervalos_de_tempo_dia++
    }
